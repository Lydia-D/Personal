%% Polar plot for azmuith and elevation
% L Drabsch
% 30/4/16
% Have elevation circles distributed as it would in the sky - nonlinesr?

function fighandle = PolarPlotVisual(newfig)
    d_el = 15;
    d_spk = 30;
    grey    = 0.65*[1 1 1];
...
%     rUnit       = cosd(90:-d_el:0) ;      % nonlinear viualisation ?
...
%     text(0,1.2,['Ground Station'num2str(number)])
