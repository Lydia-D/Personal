...
fprintf('Error detected at time of flight(s):\n')
display(dyn.acc.erroridx')
...
hold on 
plot(dyn.acc.erroridx,500,'xr')
title('Clock Bias and error detected')
legend('clock bias','error detected')
xlabel('Time of flight (s)')
